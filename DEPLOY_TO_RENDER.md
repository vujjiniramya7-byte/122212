...
5. Before clicking **Apply**, set the secret environment variables:
...
| Problem | Fix |
|---------|-----|
| `404 models/text-embedding-004 is not found` | `GEMINI_API_KEY` env var is missing or invalid — add it to backend environment variables in Render |
